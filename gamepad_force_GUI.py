...
def cyton_veta_to_game_pad():
	global my_gamepad_data, my_position, my_previous_position
        my_previous_position = [0,0,0,0,0,0,0,0]
        ...
        if -1 < my_position[7] + 0.05 * (my_gamepad_data[9] - my_gamepad_data[8]) < 1:
		my_position[7] += 0.05 * (my_gamepad_data[9] - my_gamepad_data[8])
...
def interface_setup():
	global position_ctrl, force_ctrl, ser
