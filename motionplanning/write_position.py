...
def create_position_file():
	global my_position, my_gamepad_data, file
	
	file.write(str(my_position)+"\n")
	if my_gamepad_data[8]==1:
		file.close()
	root.after(1, create_position_file)
...
root.after(25, send_joypad_update_to_global)
root.after(25, cyton_veta_to_game_pad)
root.after(10, create_position_file)
root.mainloop()
